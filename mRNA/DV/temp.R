# bladder female ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/bladder/female")
...
# bladder male ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/bladder/male")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# colon all ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/colon/all")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# colon female ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/colon/female")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
rm(list=ls())
# colon male ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/colon/male")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# kidney all ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/kidney/all")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
rm(list=ls())
# kidney female ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/kidney/female")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# kidney male ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/kidney/male")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# liver all ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/liver/all")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# liver female ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/liver/female")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# liver male ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/liver/male")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# stomach all ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/stomach/all")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# stomach female ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/stomach/female")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
...
# stomach male ##########################################################################################
setwd("/Users/namuhanz/cancer/transcripts/expression variability/file/temp/stomach/male")
countsdata <- read.csv("./Counts_homo.csv", header = F)
colnames(countsdata) <- countsdata[1,]
rownames(countsdata) <- countsdata[,1]
countsdata <- countsdata[-1,]
